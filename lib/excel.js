...
async function buildWorkbookBuffer() {
  const tickets = (await q(`
    SELECT t.ref_no, t.raised_at, t.priority, t.subject, t.status, t.escalation_level,
           ...
           t.closed_auto, t.resolution_note, t.location_text, t.external_hold,
  ...
  for (const t of tickets) {
    ts.addRow({
      ...t,
      status: (t.external_hold && ['open', 'in_progress', 'reopened'].includes(t.status)) ? 'Escalated externally' : t.status,
